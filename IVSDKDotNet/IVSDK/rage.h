...
namespace rage
{
	static HWND& g_pHWND = AddressSetter::GetRef<HWND>(0x1449DDC, 0x1352060);
	static IDirect3DDevice9* g_pDirect3DDevice = reinterpret_cast<IDirect3DDevice9*>(AddressSetter::Get(0x148AB48, 0x1345630, 0x98327));
